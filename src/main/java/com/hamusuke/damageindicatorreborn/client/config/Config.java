...
public class Config {
    ...
    public static class ClientConfig {
        ...
        public final BooleanValue enableHealPlusString;
        ...
        public ClientConfig(Builder builder) {
            ...
            this.fontSize = builder.defineInRange("font_size", 1.0D, 0.0D, 1000.0D);
            ...
            this.enableHealPlusString = builder.define("enable_heal_plus_string", true);
        ...
        public static class ColorConfig {
            ...
            public ColorConfig(Builder builder) {
                ...
                this.register(builder, "player", 85, 255, 85);
                builder.pop();
            }
            ...
            public int getRGBFromDamageSource(String source) {
                ...
                return colorConfigs.stream().filter(c -> c.path.equals("generic_damage")).toList().get(0).toRGB();
            }
